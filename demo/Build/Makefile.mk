...
$(OUT_ELF): $(STARTO) $(OBJS) $(USER_OBJS)
	...
	D:/2021qiu/lonngide/LoongIDE/rtems-4.10/bin/mips-rtems4.10-gcc.exe  -mips32 -G0 -EL -msoft-float -nostartfiles -static -T $(LINKCMDS) -o $(OUT_ELF) -e start $(STARTO) $(OBJS) $(USER_OBJS) $(LIBS) 
	@echo 'Invoking: RTEMS C Objcopy'
	D:/2021qiu/lonngide/LoongIDE/rtems-4.10/bin/mips-rtems4.10-objcopy.exe -O binary $(OUT_ELF) $(OUT_BIN)
	@echo 'Invoking: RTEMS C Size'
	D:/2021qiu/lonngide/LoongIDE/rtems-4.10/bin/mips-rtems4.10-size.exe $(OUT_ELF)
